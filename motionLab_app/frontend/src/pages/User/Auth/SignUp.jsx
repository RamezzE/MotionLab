...
const SignUpPage = () => {
  ...
  const { isAuthenticated, signup, error, clearError } = useUserStore();
          ...
          <div className="flex flex-col gap-y-4 w-full">
            <div className="flex flex-row gap-x-4 w-full">
              <div className="flex flex-col gap-y-2 text-start">
                ...
                {error.firstName && (
                  <p className="mt-1 text-red-500 text-sm text-start">{error.firstName}</p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-y-2 text-start">
                ...
                {error.lastName && (
                  <p className="mt-1 text-red-500 text-sm text-start">{error.lastName}</p>
                )}
              </div>
            </div>
            <FormField
            ...
            {error.confirmPassword && (
              <p className="mt-1 text-red-500 text-sm text-start">{error.confirmPassword}</p>
            )}
